...
INSERT INTO USER (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (2, 'user', '$2a$12$a7L.hO06B/ikT2cqtnndwepRyIJiYCvlahzGtv./EUrdpAhqGfukO', 'user', 'user', 'enabled@user.com', 1, now());
INSERT INTO USER (ID, USERNAME, PASSWORD, FIRSTNAME, LASTNAME, EMAIL, ENABLED, LASTPASSWORDRESETDATE) VALUES (3, 'disabled', '$2a$12$rLFu5c04SJmUnrXRRRo24Oq24IdxrGOLru3dVB0ZVNwuGm4vrPHMC', 'user', 'user', 'disabled@user.com', 0, now());
